...
errorcode,theta= sim.simxGetObjectOrientation(clientID,rigid,-1,sim.simx_opmode_oneshot_wait) 
errorcode,theta1= sim.simxGetObjectOrientation(clientID,target,-1,sim.simx_opmode_oneshot_wait) 

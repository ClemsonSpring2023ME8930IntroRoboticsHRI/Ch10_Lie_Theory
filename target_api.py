...
while (t := sim.getSimulationTime()) < 10000000000:
    
    theta= sim.simxGetObjectOrientation(clientID,camera,p3dx,sim.simx_opmode_oneshot_wait) 
    theta1= sim.simxGetObjectOrientation(clientID,UGV,-1,sim.simx_opmode_oneshot_wait) 
